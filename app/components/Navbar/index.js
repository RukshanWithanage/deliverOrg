...
function getTitleElement(data) {
  ...
  return (
    <View style={styles.navBarTitleContainer}>
      <Text ellipsizeMode={data.ellipsizeMode} numberOfLines={data.numberOfLines} allowFontScaling={data.allowFontScaling} style={[styles.navBarTitleText, data.style, colorStyle]}>
        {data.title}
      </Text>
    </View>
  );
...
export default connectLang(NavigationBar)
