...
class Autocomplete extends Component {
  ...
  async triggerChange() {
    ...
    const {fetchDataUrl, valueExtractor, excludedExternalNumbersString,companyId,SmartYardId,SmartStationId} = this.props;
    console.log("excludedExternalNumbersString props : "+excludedExternalNumbersString);
    if (fetchDataUrl) {
      try {
        const response = await get(fetchDataUrl, {search: inputValue,excludedExternalNumbers:excludedExternalNumbersString,companyId:companyId,SmartYardId:SmartYardId,SmartStationId:SmartStationId});
        console.log("split response : "+JSON.stringify(response));
...
Autocomplete.propTypes = {
  ...
  fetchDataUrl: string,
  excludedExternalNumbersString: string,
